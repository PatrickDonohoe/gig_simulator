  ...
  return (
    // <header data-cy="setlist_header" className="flex flex-col bg-bg-main">
      ...
      >
        <div
          data-cy="time_div"
          className="border-bold flex flex-3 max-w-60 items-center justify-center gap-1 rounded-lg border border-border-bold bg-primary p-1 text-sm font-semibold text-accent md:text-base lg:text-lg"
        >
          <span>Total:</span>
