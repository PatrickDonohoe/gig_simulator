...
const SavedSetlistsShell = ({ headerProps, children }: SavedSetlistsShellProps) => {
  return (
    <SidebarShell headerProps={headerProps} className="border-border-bold">
      <section data-cy='sidebar-setlists-shell' className="flex min-h-0 flex-1 flex-col justify-start overflow-hidden  border border-border-bold bg-primary">
        <div className="flex items-center justify-center border-b-8 border-border-bold bg-bg-main py-2 font-semibold text-2xl text-text-main">
