  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={`${className} rounded-lg bg-bg-main p-2 text-text-main ring ring-border-bold hover:bg-golden_apricot hover:text-midnight_violet focus:ring-accent active:bg-bg-surface`}
