  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={`${className} rounded-lg bg-bg-main p-2 ring ring-border-bold hover:bg-golden_apricot hover:text-midnight_violet active:bg-bg-surface focus:ring-accent`}
